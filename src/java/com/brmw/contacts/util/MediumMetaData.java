...
public class MediumMetaData extends AuditedBeanMetaData<Medium> {
    ...
    public MediumMetaData() {
        ...
        mediumColumnData.add(new BaseFieldData<Medium>(Medium.class, getRegistryKey(), "name", true));
        mediumColumnData.add(new BaseFieldData<Medium>(Medium.class, getRegistryKey(), "type", true));
        mediumColumnData.add(new BaseFieldData<Medium>(Medium.class, getRegistryKey(), "notes", true));
    }
