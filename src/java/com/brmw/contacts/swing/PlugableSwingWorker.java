...
/**
 * This is an implementation of SwingWorker with the primary interface methods delegating to 
 * a separate abstract class: <code>SwingWorkerPlugin</code>.
 * This should allow better testability.
 * 
 * @param <T>
 * @param <V>
 */
